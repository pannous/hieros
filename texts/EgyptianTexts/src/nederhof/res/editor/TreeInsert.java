...
public class TreeInsert extends ResInsert 
	implements TreeBasicgroup, TreeNode {

    // Constructor with only two groups.
    public TreeInsert(TreeTopgroup g1, TreeTopgroup g2) {
	super(new TreeSwitch(), g1, new TreeSwitch(), g2, new TreeSwitch());
	panel = new NodePanel("insert", this);
    }

    // Constructor.
    public TreeInsert(ResInsert insert) {
        super(insert.place,
            insert.x,
            insert.y,
            insert.fix,
            insert.sep,
            new TreeSwitch(insert.switchs0),
            TreeTopgroupHelper.makeGroup(insert.group1),
            insert.switchs1,
            TreeTopgroupHelper.makeGroup(insert.group2),
            new TreeSwitch(insert.switchs2));
	panel = new NodePanel("insert", this);
    }
